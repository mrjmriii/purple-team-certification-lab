...
| Phase | Status | Notes |
| --- | --- | --- |
| 01 Reconnaissance | planned | Pending phase scaffolding |
| 02 Resource Development | planned | Pending phase scaffolding |
| 03 Initial Access | planned | Pending phase scaffolding |
| 04 Execution | scaffolded | Scripts + Wazuh wiring added |
| 05 Persistence | planned | Pending phase scaffolding |
| 06 Privilege Escalation | planned | Pending phase scaffolding |
| 07 Defense Evasion | planned | Pending phase scaffolding |
| 08 Credential Access | planned | Pending phase scaffolding |
| 09 Discovery | planned | Pending phase scaffolding |
| 10 Lateral Movement | planned | Pending phase scaffolding |
| 11 Collection | planned | Pending phase scaffolding |
| 12 Command and Control | planned | Pending phase scaffolding |
| 13 Exfiltration | planned | Pending phase scaffolding |
| 14 Impact | planned | Pending phase scaffolding |
